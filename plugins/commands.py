...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/dihanofficial'),
            InlineKeyboardButton('💾 Source code', url='https://github.com/dihanofficial')
        ],
        [
...
async def show_help(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/dihanofficial'),
            InlineKeyboardButton('💾 Source', url='https://github.com/dihanofficial'),
        ]
        ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def repo_(client, message):
    ...
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/dihanofficial/VCPlayerBot>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons))
